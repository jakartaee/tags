...
public class FormatDateTag extends FormatDateSupport {
    ...
    /**
     * Constructs a new FormatDateTag. As with TagSupport, subclasses should not provide other constructors and are expected
    ...
    private void evaluateExpressions() throws JspException {
        ...
        // 'dateStyle' attribute
        if (dateStyle_ != null) {
            dateStyle = (String) ExpressionEvaluatorManager.evaluate("dateStyle", dateStyle_, String.class, this, pageContext);
        }

        // 'timeStyle' attribute
        if (timeStyle_ != null) {
            timeStyle = (String) ExpressionEvaluatorManager.evaluate("timeStyle", timeStyle_, String.class, this, pageContext);
        }
        ...
        // 'timeZone' attribute
        if (timeZone_ != null) {
            timeZone = ExpressionEvaluatorManager.evaluate("timeZone", timeZone_, Object.class, this, pageContext);
        }
    }
}
